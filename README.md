...
parser.add_argument('-intersect_list', dest='intersect_list', action='store', default='/private/common/Software/OrshaysPipeline/Genomes/hg38/bedIntersectionList_v7.txt', help='List of bed files to intersect and filter')
