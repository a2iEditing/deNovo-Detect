...
parser.add_argument('-g', '--genome', dest='genome', action='store', default='/private/common/Software/OrshaysPipeline/Genomes/hg38/hg38_all.fa', help='Path to the genome of samples')
parser.add_argument('-pre', '--prefix', dest='pre', action='store', default='SRR', help='Prefix of alignment files | Default prefix: SRR')
parser.add_argument('-chrom_length', dest='chrom_length', action='store', default='/private/common/Software/OrshaysPipeline/Genomes/hg38/chrNameLength.txt', help='List of all chromosomes length for the genome in use')
parser.add_argument('-intersect_list', dest='intersect_list', action='store', default='/private/common/Software/OrshaysPipeline/Genomes/hg38/Bed_intersection_files/bedIntersectionList_v7.txt', help='List of bed files to intersect and filter')
